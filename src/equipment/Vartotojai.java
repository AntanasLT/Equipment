 ...
 * @author a
 */
public class Vartotojai extends Sistemos {

    private static final String SELECT_ALL = "SELECT ID, Vardas FROM Vartotojai ORDER BY ID";
    private static final String PREPARE_DELETE = "DELETE FROM Vartotojai WHERE ID = ?";
