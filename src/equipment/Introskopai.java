 ...
 */
public class Introskopai extends ID_auto {
     ...
     */
    protected Introskopai(ConnectionEquipment the_connection, int size, String tbl) {
...
//    }
	...
	select = "SELECT i.Nr, i.Pavadinimas,  g.Nr, COUNT(g.Nr) FROM Introskopai i INNER JOIN JSG g WHERE g.Introskopas = i.Nr GROUP BY i.Nr";
     }
